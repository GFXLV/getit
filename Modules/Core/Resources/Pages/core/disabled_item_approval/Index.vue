<template>
    <Head :title="$t('disable_item_module')" />
    <ps-layout>
        ...
        <ps-table2 ::row="row" :search="search" :object="this.items" :colFilterOptions="colFilterOptions"
            ...
            :globalSearchPlaceholder="$t('core__be_disable_search_item')"
            ...
            <template #tableRow="rowProps">
                <div class="flex flex-row" v-if="rowProps.field == 'enable'">
    ...
    components: {
        ...
        setup(props) {
            ...
            const columns = [
                ...
                {
                    label: trans('core__be_enable_lbl'),
                    field: "enable",
                    type: "String",
                    sort: false,
                },
            ...
            ps_danger_dialog.value.openModal(
                trans('core__be_delete_disable_item'),
                trans('core__be_delete_disable_item_info'),
            ...
            function handleStatusChange(id) {
                this.$inertia.put(route('disable_item.statusChange', id), form);
            }
            // Category data
