<template>
    ...
    <Head :title="$t('core__be_disable_item_detail')" />
    <ps-layout>
        ...
        <ps-card class="w-full h-auto">
            <div class="rounded-xl">
                ...
                <div class="bg-primary-50 dark:bg-primary-900 py-2.5 ps-4 rounded-t-xl">
                    <ps-label-header5>{{$t('core__be_disable_item_detail')}}</ps-label-header5>
                </div>
                <!-- card header end -->
...
export default defineComponent({
    ...
    computed: {
        breadcrumb() {
            return [
                ...
                {
                    label: trans('disable_item_module'),
                    url: route('disable_item.index'),
                },
                {
                    label: trans('core__be_disable_item_detail'),
    ...
    methods: {
        handleCancel() {
            this.$inertia.get(route('disable_item.index'));
        },
    },
})
</script>
