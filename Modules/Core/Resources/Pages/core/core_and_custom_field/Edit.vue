<template>
    <Head :title="$t('edit_mobile_language')" />
    <ps-layout>
         <!-- breadcrumb start -->
        ...
        <ps-card class="w-full h-auto">
            <div class="bg-background rounded-lg overflow-hidden">
                ...
                <div class="bg-primary-50 dark:bg-primary-900 py-2.5 ps-4 rounded-t-xl">
                    <ps-label-header-6 textColor="text-secondary-800 dark:text-secondary-100">{{$t('edit_mobile_language')}}</ps-label-header-6>
                </div>
                <!-- card header end -->
                        ...
                        <div class="grid w-full sm:w-1/2 gap-6">
                            ...
                            <div class="flex flex-row justify-end mb-2.5">
                                ...
                                <ps-button  class="transition-all duration-300 min-w-3xs" padding="px-7 py-2" rounded="rounded" hover="" focus="" >
                                    ...
                                    <span v-if="success" class="transition-all duration-300">Updated</span>
                                    <span v-if="!loading && !success" class="" > Update </span>
                                </ps-button>
                            </div>
                        </div>
                    </form>
