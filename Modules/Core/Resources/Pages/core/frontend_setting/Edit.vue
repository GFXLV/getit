...
<script>
    ...
    export default defineComponent({
        ...
        layout: PsLayout,
        props: ['errors', 'available_languages', 'frontend_setting'],
        data(props) {
            const settingColumn = [
                {
        ...
        setup(props) {
            ...
            return { validateEmptyInput, onlyNumber, form ,checkedSelectedList}
        },
        methods: {
            handleSubmit(id) {
                this.$inertia.post(route('frontend_setting.update',id), this.form,{forceFormData: true});
            },
        },
        computed: {
            breadcrumb() {
