        ...
        <ps-card class="w-full h-auto">
            <div class="rounded-xl">
                ...
                <div class="bg-primary-50 dark:bg-primary-900 py-2.5 ps-4 rounded-t-xl">
                    <ps-label-header-6 textColor="text-secondary-800 dark:text-secondary-100">{{$t('core__be_pending_item_detail')}}</ps-label-header-6>
                </div>
                <!-- card header end -->
                            ...
                            <div class="grid gap-6">
                                ...
                                <div v-for="(custom_field_header) in customizeHeaders.filter((custom) => custom.core_keys_id != 'ps-itm00009')" :key="custom_field_header.id">
                                    ...
                                    <div class="md:me-6 sm:me-0" v-if="custom_field_header.ui_type_id === 'uit00003' && custom_field_header.enable === 1 && custom_field_header.is_delete === 0 ">
                                        ...
                                        <div class="flex flex-row">
                                            <div class="mr-2" v-for="detail in customizeDetails.filter((customizeDetail) => customizeDetail.core_keys_id === custom_field_header.core_keys_id )" :key="detail.id">
                                                ...
                                                <ps-label textColor="text-secondary-300 dark:text-secondary-700" :for="detail.id">{{detail.attribute}}</ps-label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:me-6 sm:me-0" v-if="custom_field_header.ui_type_id === 'uit00004' && custom_field_header.enable === 1 && custom_field_header.is_delete === 0">
                                        ...
                                        <div class="flex flex-row">
                                            <div class="mr-2 flex">
                                                ...
                                                <ps-label textColor="text-secondary-300 dark:text-secondary-700" class="text-base ms-2">{{$t(custom_field_header.placeholder)}}</ps-label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="md:me-6 sm:me-0" v-if="custom_field_header.ui_type_id === 'uit00009' && custom_field_header.enable === 1 && custom_field_header.is_delete === 0">
                                        ...
                                        <div v-if="item.image" class="flex items-end pt-4">
                                            <img v-lazy=" { src: $page.props.uploadUrl + '/' + item.image.img_path, loading: $page.props.sysImageUrl+'/default_photo.png', error: $page.props.sysImageUrl+'/default_photo.png' }" class="w-96 h-48" :alt="$t(core__be_item_photo)" />
                                ...
                                <div>
                                    ...
                                    <div v-if="item.cover[0]" class="flex items-end pt-4">
                                        <img v-lazy=" { src: $page.props.uploadUrl + '/' + item.cover[0].img_path, loading: $page.props.sysImageUrl+'/default_photo.png', error: $page.props.sysImageUrl+'/default_photo.png' }" class="w-96 h-48" :alt="$t(core__be_item_photo)" />
                                ...
                                <div>
                                    ...
                                    <div v-if="item.icon[0]" class="flex items-end pt-4">
                                        <img v-lazy=" { src: $page.props.uploadUrl + '/' + item.icon[0].img_path, loading: $page.props.sysImageUrl+'/default_photo.png', error: $page.props.sysImageUrl+'/default_photo.png' }" class="w-72 h-48" :alt="$t(core__be_item_icon)" />
...
export default defineComponent({
    ...
    computed: {
        breadcrumb() {
            return [
                ...
                {
                    label: trans('pending_item_module'),
                    url: route('pending_item.index'),
                },
                {
                    label: trans('core__be_pending_item_detail'),
    ...
    methods: {
        handleCancel() {
            this.$inertia.get(route('pending_item.index'));
        },
    },
})
</script>
