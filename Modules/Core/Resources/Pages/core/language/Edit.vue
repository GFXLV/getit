<template>
    <Head :title="$t('core_be_edit_language')" />
    <ps-layout>
         <!-- breadcrumb start -->
        ...
        <ps-card class="w-full h-auto">
            <div class="rounded-xl">
                ...
                <div class="px-4 pt-6 dark:bg-backgroundDark">
                    <form @submit.prevent="handleSubmit(this.language.id)">
                        <div class="grid w-full sm:w-1/2 gap-6">
                            <div>
                                ...
                                <ps-input  :disabled="true" type="text" ref="symbol" v-model:value="form.symbol" :placeholder="$t('core__be_symbol_label')"
...
export default defineComponent({
    ...
    setup(props) {
        ...
        function handleSubmit(id) {
            this.$inertia.post(route('language.update', id), form, {
                forceFormData: true,
    ...
    computed: {
        breadcrumb() {
            ...
            return [
                ...
                {
                    label: trans('core_be_edit_language'),
