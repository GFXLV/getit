...
namespace Modules\Core\Transformers\Backend\NoModel\BannedUser;
...
class BannedUserWithKeyResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'authorizations' => authorizationWithoutPolicy(Constants::bannedUserModule)
        ] + $changedCustomFieldFormat;
    }
}
