...
namespace Modules\Core\Transformers\Backend\NoModel\Reject;
...
class RejectWithKeyResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'authorizations' => authorizationWithoutPolicy(Constants::rejectModule)        
        ] + $changedCustomFieldFormat;            
    }
}
