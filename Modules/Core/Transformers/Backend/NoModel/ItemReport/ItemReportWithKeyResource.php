...
namespace Modules\Core\Transformers\Backend\NoModel\ItemReport;
...
class ItemReportWithKeyResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'authorizations' => authorizationWithoutPolicy(Constants::itemReportModule)        
        ] + $changedCustomFieldFormat;            
    }
}
