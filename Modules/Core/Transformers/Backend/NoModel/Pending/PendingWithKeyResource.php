...
namespace Modules\Core\Transformers\Backend\NoModel\Pending;
...
class PendingWithKeyResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'authorizations' => authorizationWithoutPolicy(Constants::pendingModule)        
        ] + $changedCustomFieldFormat;            
    }
}
