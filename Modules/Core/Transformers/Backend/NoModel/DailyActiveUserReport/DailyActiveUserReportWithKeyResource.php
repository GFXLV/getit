...
namespace Modules\Core\Transformers\Backend\NoModel\DailyActiveUserReport;
...
class DailyActiveUserReportWithKeyResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'authorizations' => authorizationWithoutPolicy(Constants::dailyActiveUserReportModule)
        ] + $changedCustomFieldFormat;
    }
}
