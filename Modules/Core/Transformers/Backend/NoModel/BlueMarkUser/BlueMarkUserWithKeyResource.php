...
namespace Modules\Core\Transformers\Backend\NoModel\BlueMarkUser;
...
class BlueMarkUserWithKeyResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'bluemark_updated_at' => $this->bluemark_updated_at,
            'updated_user_id' => $this->updated_user_id,
            'udpated_user_id@@name' => isset($this->editor) && !empty($this->editor)?$this->editor->name:'',
            'updated_flag' => $this->updated_flag,
            'authorizations' => authorizationWithoutPolicy(Constants::blueMarkUserModule)
        ] + $changedCustomFieldFormat;
    }
}
