...
namespace Modules\Core\Transformers\Backend\NoModel\SlowMovingItem;
...
class SlowMovingItemWithKeyResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'authorizations' => authorizationWithoutPolicy(Constants::slowMovingItemModule)        
        ] + $changedCustomFieldFormat;            
    }
}
