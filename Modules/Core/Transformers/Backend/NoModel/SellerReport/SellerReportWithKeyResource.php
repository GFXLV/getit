...
namespace Modules\Core\Transformers\Backend\NoModel\SellerReport;
...
class SellerReportWithKeyResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'authorizations' => authorizationWithoutPolicy(Constants::sellerReportModule)
        ] + $changedCustomFieldFormat;
    }
}
