<template>
    <Head :title="$t('core__be_complaint_item_report_detail')" />
    <ps-layout>
        ...
        <ps-card class="w-full h-auto">
            <div class="rounded-xl">
                ...
                <div class="bg-primary-50 dark:bg-primary-900 py-2.5 ps-4 rounded-t-xl">
                    <ps-label-header5>{{$t('core__be_complaint_item_report_detail')}}</ps-label-header5>
                </div>
                <!-- card header end -->
                            ...
                            <div class="grid gap-6">
                                ...
                                <div v-for="(custom_field_header) in customizeHeaders.filter((custom) => custom.core_keys_id != 'ps-itm00009')" :key="custom_field_header.id">
                                    ...
                                    <div class="md:me-6 sm:me-0" v-if="custom_field_header.ui_type_id === 'uit00005' && custom_field_header.enable === 1 && custom_field_header.is_delete === 0">
                                        <ps-label  class="text-base">{{ $t(custom_field_header.name) }}<span class="text-red-800 font-medium ms-1" v-show="custom_field_header.mandatory === 1">*</span></ps-label>
                                        <div>
                                            <date-picker class="w-full" :disabled="true" v-model:value="form.product_relation[custom_field_header.core_keys_id]" @keyup="handleCustomFieldError(custom_field_header)" @blur="handleCustomFieldError(custom_field_header)" :enableTimePicker="true" :inline="false" :autoApply="false" />
                                        </div>
                                    </div>
...
export default defineComponent({
        ...
        breadcrumb() {
            return [
                ...
                },
                {
                    ...
                    url: route('complaint_item_report.index'),
                },
                {
                    label: trans('core__be_complaint_item_report_detail'),
    ...
    methods: {
        handleCancel() {
            this.$inertia.get(route('complaint_item_report.index'));
        },
    },
})
</script>
