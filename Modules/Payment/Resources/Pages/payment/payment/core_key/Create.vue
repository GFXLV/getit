<template>
    ...
    <Head :title="$t('payment__be_create_key')" />
    <ps-layout>
        <!-- breadcrumb start -->
...
export default defineComponent({
    ...
    setup(props) {
        ...
        function handleSubmit() {
            this.$inertia.post(route("payment_core_key.store", props.payment_id), form, {
                forceFormData: true,
                onBefore: () => {
                    loading.value = true;
                },
        ...
        const breadcrumb = [
            ...
            {
                label: trans('payment__be_create_key'),
        ...
        return { description, name, validateDescriptionInput, validateNameInput, handleSubmit, form, loading, success, breadcrumb, handleCancel };
    },
})
</script>
